...
export const Dashboard: React.FC<DashboardProps> = () => {
    ...
    const stats = useMemo(() => {
        // CORREÇÃO: ADICIONAR WAITING TIME AO CUSTO TOTAL
        ...
        // CORREÇÃO: ADICIONAR WAITING TIME AO PENDENTE
        const totalPending = filteredServices
            .filter(s => !s.paid)
            .reduce((sum, s) => sum + s.cost + (s.waitingTime || 0), 0);
        ...
        // CORREÇÃO: ADICIONAR WAITING TIME À RECEITA POR MÉTODO
    ...
    const chartData = useMemo(() => {
        ...
        // CORREÇÃO: ADICIONAR WAITING TIME AO GRÁFICO
    ...
    const topClients = useMemo(() => {
        ...
        filteredServices.forEach(s => {
            ...
            entry.count += 1;
            // CORREÇÃO: ADICIONAR WAITING TIME AOS TOP CLIENTES
            entry.revenue += s.cost + (s.waitingTime || 0);
